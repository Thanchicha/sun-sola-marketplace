...
import Footer from "./0-Component/Footer";

import ForgetPass from "./1-LoginPage/ForgetPass";

import Home from "./2-HomePage/Home";
import RecommendPage from "./2-HomePage/RecommendPage";
    ...
    <>
      <Routes>
        ...
        <Route path="/" element={<Home />} />
          ...
          <Route
            path="/allshop/shop/:id/review/:user_id/add"
            element={<AddReview />}
          />
          <Route
            path="/allshop/shop/:id/review/:reviewId/update"
